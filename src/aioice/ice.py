"""
Modified aioice ICE implementation for high RTT/high error network conditions.

Key modifications:
- CONSENT_FAILURES increased from 6 to 60 (5 minutes of failures)
- This prevents "Consent to send expired" errors in challenging network conditions
"""
...
CONSENT_FAILURES = 60  # Increased from 6 to 60 (5 minutes of failures)
CONSENT_INTERVAL = 5
...
class Connection:
    ...
    async def connect(self) -> None:
        ...
        # Note: CONSENT_FAILURES increased to 60 to prevent premature connection closure
        # in high RTT/high error network conditions
